...
SPI.beginTransaction(SPISettings(FreqSP1, MSBFIRST, SPI_MODE0));
#endif
...
#if defined(ARDUINO) && !defined(__DUE__) && !defined(ESP8266) && !defined(ARDUINO_ARCH_STM32L4) && !defined(ESP32) && !defined(ARDUINO_ARCH_STM32)
