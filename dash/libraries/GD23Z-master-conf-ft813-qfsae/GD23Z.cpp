...
#if (LFFC==15)
SPISettings settingsT36(21000000, MSBFIRST, SPI_MODE0); 
#endif

#if (LFFC==5)
SPISettings settingsT36(36000000, MSBFIRST, SPI_MODE0); 
#endif

#if defined(ARDUINO_ARCH_STM32)
  SPISettings settingsSD(FreqSD2, MSBFIRST, SPI_MODE0); 
#endif
...
SdFat SD(2);  const uint8_t SD_CS = PA11; //F767
  //SdFat SD(3); const uint8_t SD_CS = PA15;  //F429
  //SdFatSdio SD;

  File archivo;
  
  SD.begin(SD_CS, SD_SCK_MHZ(FreqSD2));
  //SD.begin();
...
#if defined(ARDUINO) && !defined(__DUE__) && !defined(ARDUINO_ARCH_STM32)
...
GD.ColorA(85);
if (SCREEN_FT81X==14){
    GD.Vertex2ii((GD.w / 2)-50, (GD.h / 2)-130, 0, 0);
}

if (SCREEN_FT81X==15){
    GD.Vertex2ii((GD.w / 2)-50, (GD.h / 2)-110, 0, 0);
}
...
if (SCREEN_FT81X==15){
  cmd_text(GD.w / 2, GD.h / 2, 29, OPT_CENTERX, "Toca el punto para calibrar touch");
}

if (SCREEN_FT81X==16){
  cmd_text(GD.w / 2, GD.h / 2, 27, OPT_CENTERX, "Toca el punto para calibrar touch");
}
...
//RndMnkIII: m\E9todo loadSDIO para carga de assets desde lector SDIO tarjetas Teensy 3.5/3.6
byte GDClass::loadSDIO(File& archivo, void (*progress)(long, long))
{
  int offset=0;
  int offsetFT;
...
//FT81XMANIA TEAM (TFTLCDCyg)
  ...
  //GD.ColorA(255);
   ...
   cmd_text(GD.w / 2, (GD.h / 2) - (GD.h / 20), 30, OPT_CENTERX, "ERROR");
   cmd_text(GD.w / 2, (GD.h / 2) + (GD.h / 20), 29, OPT_CENTERX, "Revisar comandos:");
   cmd_text(GD.w / 2, (GD.h / 2) + 3*(GD.h / 20), 26, OPT_CENTERX, "- Falta GD.Swap");
   cmd_text(GD.w / 2, (GD.h / 2) + 4*(GD.h / 20), 26, OPT_CENTERX, "- Revisar nombre de archivo png o jpg");
   cmd_text(GD.w / 2, (GD.h / 2) + 5*(GD.h / 20), 26, OPT_CENTERX, "- Grabar archivo png o jpg en la tarjeta microSD");
   cmd_text(GD.w / 2, (GD.h / 2) + 6*(GD.h / 20), 26, OPT_CENTERX, "- Revisar sintaxis de instrucciones");
}

   if (SCREEN_FT81X==16){

   cmd_text(GD.w / 2, (GD.h / 2) - (GD.h / 20), 30, OPT_CENTERX, "ERROR");
   cmd_text(GD.w / 2, (GD.h / 2) + (GD.h / 20), 28, OPT_CENTERX, "Revisar comandos:");
   cmd_text(GD.w / 2, (GD.h / 2) + 3*(GD.h / 20), 26, OPT_CENTERX, "- Falta GD.Swap");
   cmd_text(GD.w / 2, (GD.h / 2) + 4*(GD.h / 20), 26, OPT_CENTERX, "- Revisar nombre de archivo png o jpg");
   cmd_text(GD.w / 2, (GD.h / 2) + 5*(GD.h / 20), 26, OPT_CENTERX, "- Grabar archivo png o jpg en la tarjeta microSD");
   cmd_text(GD.w / 2, (GD.h / 2) + 6*(GD.h / 20), 26, OPT_CENTERX, "- Revisar sintaxis de instrucciones");
...
//RndMnkIII: m\E9todo safeloadSDIO para carga de assets desde lector SDIO tarjetas Teensy 3.5/3.6
